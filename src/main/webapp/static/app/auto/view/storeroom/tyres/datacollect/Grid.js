...
Ext.define('App.view.storeroom.tyres.datacollect.Grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.tyresdatacollect_grid',
    store: 'syj_qt_collect',
    selModel: sm,
    id :'grid_qt_collect',
    initComponent: function () {
        this.columns = [
            ...
            {text: '使用天数', width: 80, dataIndex: 'uesday'},
            {text: '使用月数', width: 80, dataIndex: 'uesmonth'},
            {text: '刻沟贡献率', width: 80, dataIndex: 'contrate'},
            {text: '百公里成本', width: 80, dataIndex: 'costs'},
